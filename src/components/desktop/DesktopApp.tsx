...
function App() {
  ...
  // ==================================================================================
  const Header = () => (
    <header className="fixed top-0 w-full z-50 bg-black/95 backdrop-blur-sm border-b border-gray-800 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 py-3">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <div className="flex items-center space-x-3 h-10 overflow-visible relative z-50">
            <img 
              src="/logo-upupupfinal.png" 
              alt="UP UP UP Logo" 
              className="w-auto h-48 object-contain drop-shadow-lg mt-1 relative z-50"
            />
          </div>
    ...
    <section className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-purple-900 relative overflow-hidden flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
             <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-8 leading-tight whitespace-pre-line">
            ...
            <div className="space-y-4">
             ...
             <div className="grid grid-cols-2 gap-8 mt-12">
               <div className="text-center">
                 ...
                 <div className="text-gray-300">Plus de leads qualifiés</div>
               </div>
               <div className="text-center">
                 <div className="text-3xl font-bold text-blue-400 mb-2">-60%</div>
                 <div className="text-gray-300">De temps de prospection</div>
               </div>
             </div>
          </motion.div>
            ...
            <div className="relative w-[640px] h-[640px] lg:w-[760px] lg:h-[760px]">
              ...
              <PlanetOrbit radiusPx={210} initialAngleDeg={20} periodSec={30} direction={1} scaleX={1}>
                <div className="w-14 h-14 flex items-center justify-center z-30">
                  <img src="/upupup-logocoupe-removebg-preview.png" alt="Logo UP UP UP Planète" className="w-12 h-12 object-contain" />
                </div>
              </PlanetOrbit>
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center mb-6">
            <img 
              src="/logo-upupupfinal.png" 
              alt="UP UP UP Logo" 
               className="w-auto h-40 object-contain drop-shadow-lg"
            />
          </div>
  ...
  const StickyCTAButton = () => {
    ...
    return (
      ...
      >
        ...
        >
          <span>Obtenir un audit commercial gratuit</span>
