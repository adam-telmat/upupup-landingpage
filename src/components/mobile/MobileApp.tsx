    ...
    <section className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-purple-900 relative overflow-hidden flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-6 py-32 relative z-10">
        <div className="flex flex-col gap-10 items-center">
          ...
          >
            <h1 className="text-lg font-bold text-white mb-8 leading-tight px-2">
            ...
            <div className="grid grid-cols-2 gap-4 mt-10">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-400 mb-1">3 min</div>
                <div className="text-sm text-gray-300">Consultation générée</div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative w-[300px] h-[300px]">
              ...
              <PlanetOrbit radiusPx={100} initialAngleDeg={20} periodSec={30} direction={1} scaleX={1}>
                <div className="w-8 h-8 flex items-center justify-center z-30">
                  <img src="/logo-c-sun.jpeg" alt="Logo C Planète" className="w-6 h-6 object-contain" />
                </div>
              </PlanetOrbit>
